...
public class demo extends Application{
    ...
    public void start(Stage primaryStage)throws Exception{
        ...
        button4.setStyle("-fx-font-size: 22;-fx-background-color: dark grey; -fx-text-fill: white;-fx-font-style: italic;");
        ...
        primaryStage.setTitle("Laptop Lens");
        primaryStage.show();  
        ...
        backButton.setOnAction(event -> {demo sc=new demo();
        try {
    ...
    public void openInfoPage() {
        ...
        secondStage.setTitle("Model Information");
        Pane root = new Pane();
        ...
        root.getChildren().addAll(imageView1,imageView2,imageView3,imageView4,imageButton,imageButton2,imageButton3,imageButton4 );
    ...
    public void openSecondPage() {
        ...
        text2.setText("Our mission is to provide users with comprehensive information and unbiased comparisons of various laptop models to help you make informed decisions when choosing your next laptop. Whether you're a student, professional, or tech enthusiast, we're here to assist you in finding the perfect laptop that suits your needs."); // Enable text wrapping
        text2.setX(30);
        text2.setY(100);
        ...
        text5.setText("Prachi Dawkhar                Sampada Bhosale    Sahil Gade                        Shivam Chincholkar      Aditya Shinde");
        text5.setX(70);
        text5.setY(465);
        ...
        text8.setText("Govind Dindewad                Shivkumar Tengse     Vishal Lohbande                  Prajwal Kadam     Subodh Yelgandharwar");
        text8.setX(70);
        text8.setY(320);
        ...
        Image image = new Image("c2w_owner.jpg");
        ImageView imageView = new ImageView(image);
        imageView.setFitWidth(350);
        imageView.setFitHeight(280);  

        Image image2 = new Image("logo.jpg"); // Replace with your image file path
        ImageView imageView2 = new ImageView(image2);
        ...
        rightHalf.getChildren().addAll(backButton,imageView2,imageView,text6,text7);
